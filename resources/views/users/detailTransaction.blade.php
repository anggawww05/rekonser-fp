...
<div class="border rounded-lg shadow-sm p-4 bg-white">
    ...
    <div class="text-sm space-y-2">
        ...
        <div class="border rounded-lg shadow-sm p-4 bg-white">
            ...
            <input type="file" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border file:border-gray-300 file:text-sm file:font-semibold file:bg-gray-50 file:text-gray-700 hover:file:bg-gray-100">
        </div>
