                    ...
                    <table class="w-[1220px] table-auto ">
                        <tbody class="">
                            <tr class="text-center w-full bg-white ring-1 ring-[#AAAAAA] inline-table my-1 rounded-lg ">
                                <td class="aspect-square w-[100px] h-[100px] bg-gray-300 flex items-center justify-center text-gray-500 border rounded-lg m-4">Foto 1x1</td>
                                <td class=" w-[80%] p-4 text-left "><p class=" font-extrabold">Sony a6400</p>
                                <p>Rp. 95.000/hari</p>
                                <td class="w-[20%]  p-4 text-center">
                                    <div class=" w-[120px]">
                                        <button type="Lihat Detail"
                                            class="w-[180px] h-[40px] bg-[#003A5B] text-white rounded-lg hover:bg-[#004A73] transition">Lihat Detail</button>
                                    </div>
                                </td>
                            </tr>
                            <tr class="text-center w-full bg-white ring-1 ring-[#AAAAAA] inline-table my-1 rounded-lg ">
